      ...
      '<div class="testimonial_slide" style="width: {{slide.width}}px;">' +
        '<div class="content">' +
            ...
            '<div class="quote">' +
              '<div class="text">' +
                '<div class="quotation_mark left">' +
                  '<img src="img/quotation_mark.png">' +
                '</div>' +
                '<p>{{slide.quote}}</p>' +
                '<div class="quotation_mark right">' +
                  '<img src="img/quotation_mark_inverted.png">' +
                '</div>' +
              '</div>' +
            '</div>' +
            '<div class="signature">' +
          ...
          '<div class="avatar">' +
            '<div class="block">' +
              '<div class="author">' +
                '<img src="{{slide.author.avatar}}" style="height:auto; width:auto; max-width:146px; max-height:146px;">' +
              '</div>' +
              '<div class="helper">' +
              '</div>' +
            '</div>' +
